...
plot_rainflow_3d(S_r, S_0, n_i,
                 delta_S_r=250, delta_S_0=25,
                 tick_Sr=250, tick_S0=25,
...
plot_damage_3d(S_r, S_0, D_ni_d,
    delta_S_r=250, delta_S_0=25,        # range dell'istogramma
    tick_Sr=250, tick_S0=25 ,           # range dei valori sugli assi x e y
    Dmin=0.0, Dmax=None, tick_D=0.05)

plot_damage_map(S_r, S_0, D_ni_d,
    delta_S_r=250, delta_S_0=25,        # range dela mappa
    tick_Sr=250, tick_S0=25 ,           # range dei valori sugli assi x e y
    Dmin=0.0, Dmax=None, tick_D=0.05)
